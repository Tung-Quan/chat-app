...
const ChatContainer = () => {
  const { selectedUser, messages, loading, deleteMessage } = useChat();
            ...
            return (
              ...
              >
                <div className="relative max-w-[85%] sm:max-w-[70%]">
                  ...
                  {isMine && hoveredMessage === message._id && (
                    <button
                      onClick={() => handleDeleteMessage(message._id)}
                      className="absolute -left-8 top-1/2 -translate-y-1/2 p-1.5 bg-red-500 text-white rounded-full hover:bg-red-600 transition opacity-0 group-hover:opacity-100"
